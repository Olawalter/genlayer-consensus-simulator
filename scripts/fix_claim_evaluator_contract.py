"""Fix CLAIM_EVALUATOR_CONTRACT: use gl.vm.run_nondet_unsafe pattern for LLM calls."""
import pathlib

ROOT = pathlib.Path("C:/GenB/GenLayer Consensus Simulator")
target = ROOT / "lib/genlayer/contracts.ts"

# The contract — gl.nondet.exec_prompt must be inside gl.vm.run_nondet_unsafe
CONTRACT = '''\
...
ts_content = f'// Standard Intelligent Contract used by the Playground claim simulator\nexport const CLAIM_EVALUATOR_CONTRACT = `{CONTRACT}`;\n'
